package me.rigelmc.rigelmcmod.config;
...
public enum ConfigEntry
{
    ...
    SERVER_ESSENTIALS(String.class, "server.essentials"),
    //
    ...
    SHOP_SETTING_LOGIN_MESSAGE_PRICE(Integer.class, "shpo.setting_login_message_price"),
    ...
    {
        return RigelMCMod.plugin().config;
    }
