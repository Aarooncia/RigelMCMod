package me.rigelmc.rigelmcmod.player;
...
import me.rigelmc.rigelmcmod.caging.CageData;
import me.rigelmc.rigelmcmod.config.ConfigEntry;
import me.rigelmc.rigelmcmod.freeze.FreezeData;
...
public class FPlayer
{
    ...
    public FPlayer(RigelMCMod plugin, Player player)
    {
        this(plugin, player.getName(), Ips.getIp(player));
    }

    private FPlayer(RigelMCMod plugin, String name, String ip)
    {
        this.plugin = plugin;
        this.name = name;
        this.ip = ip;
    ...
    public void startArrowShooter(RigelMCMod plugin)
    {
