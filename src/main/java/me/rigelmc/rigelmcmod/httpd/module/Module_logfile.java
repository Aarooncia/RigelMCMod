...
import me.rigelmc.rigelmcmod.httpd.HTMLGenerationTools;
...
public class Module_logfile extends HTTPDModule
{
    ...
    public Module_logfile(RigelMCMod plugin, NanoHTTPD.HTTPSession session)
    {
    ...
    public String body() throws ResponseOverrideException
    {
        ...
        switch (mode)
        {
            case LIST:
            {
                ...
                {
                    out.append(HTMLGenerationTools.paragraph("RigelMC - Logs"));
                ...
                else
                {
                    ...
                    out
                            .append(HTMLGenerationTools.heading("RigelMC Logfiles:", 1))
                            .append("<ul>")
