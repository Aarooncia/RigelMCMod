...
import static me.rigelmc.rigelmcmod.httpd.HTMLGenerationTools.heading;
import static me.rigelmc.rigelmcmod.httpd.HTMLGenerationTools.paragraph;
...
public class Module_help extends HTTPDModule
{
    ...
    public Module_help(RigelMCMod plugin, NanoHTTPD.HTTPSession session)
    {
    ...
    public String getBody()
    {
        ...
        while (it.hasNext())
        {
            ...
            {
                if (!RigelMCMod.pluginName.equals(pluginName))
                {
